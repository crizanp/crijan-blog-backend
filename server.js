...
const app = express();
app.use(cors({
  origin: ['https://crijan-personal.vercel.app', 'https://srijanpokhrel.com.np', 'http://localhost:3000', 'http://localhost:3001', 'http://localhost:3002', 'https://crijanblog.vercel.app'],
}));
